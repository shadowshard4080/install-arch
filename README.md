...
> Note: For an Updated, more accurate version of this doccument, go to [el-wumbus.github.io/wiki](https://el-wumbus.github.io/wiki/Main-Arch-Linux-install-Guide.html). This file may not be accurate.
